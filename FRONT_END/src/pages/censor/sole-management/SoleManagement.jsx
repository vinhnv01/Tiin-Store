...
import "./SoleManagement.model.css";
import ConvertLongToDate from "../../../util/date/ConverLongToDate";
import { useAppDispatch, useAppSelector } from "../../../app/hook";
import ModalAddSole from "./modal/add";
import { SoleAPI } from "../../../apis/sole/sole.api";
import { GetSole, SetSole } from "../../../app/reducer/Sole.reducer";
import ModalUpdateSole from "./modal/update";
import ModalDetailSole from "./modal/Detail";

export default function SoleManagement() {
      ...
      <Form form={form}>
        ...
        <Card style={{ marginTop: "35px" }}>
          ...
          <Row justify="end" align="middle">
            ...
            <ModalAddSole visible={openAdd} onCancel={handleCancel} />
          </Row>
          <Table
            columns={columns}
            dataSource={data}
